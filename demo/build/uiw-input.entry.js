...
var NWCC_INPUT_TYPE;
(function (NWCC_INPUT_TYPE) {
  NWCC_INPUT_TYPE["TEXT"] = "text";
  NWCC_INPUT_TYPE["CURRENCY"] = "currency";
  NWCC_INPUT_TYPE["EMAIL"] = "email";
})(NWCC_INPUT_TYPE || (NWCC_INPUT_TYPE = {}));
...
let NwccInput = class {
  constructor(hostRef) {
    ...
    this.nwccInputChange = createEvent(this, "nwccInputChange", 7);
    this.nwccInputFocus = createEvent(this, "nwccInputFocus", 7);
    this.nwccInputBlur = createEvent(this, "nwccInputBlur", 7);
    this.nwccInputKeyDown = createEvent(this, "nwccInputKeyDown", 7);
    this.nwccInputValidate = createEvent(this, "nwccInputValidate", 7);
    this.nwccInputValidateDebounced = createEvent(this, "nwccInputValidateDebounced", 7);
    var _a;
    this.value = '';
    this.placeholder = '';
    this.postfix = '';
    ...
    this.note = '';
    this.name = '';
    this.type = NWCC_INPUT_TYPE.TEXT;
    this.inputmode = 'text';
    this.counter = 0;
    this.disabled = false;
    /**
...
NwccInput.style = uiwInputCss;

export { NwccInput as uiw_input };
